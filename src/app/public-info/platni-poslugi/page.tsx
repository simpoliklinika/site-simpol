...
export default async function PlatniPoslugiPage() {
  ...
  const res = await fetch(`${strapiUrl}/api/platni-poslugi?populate=table`, {
    cache: "no-store",
  });
  ...
  const tableFile = json.data?.table;
  if (!tableFile) {
    return (
      <main className="container mx-auto p-4">
  ...
  return (
    <main className="container mx-auto px-4 py-8">
      <h1 className="text-2xl font-bold mb-6">Платні послуги</h1>
      <a
        href={fileUrl}
        download={fileName}
        className="
