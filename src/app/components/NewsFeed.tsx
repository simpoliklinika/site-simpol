...
const newsItems: NewsItem[] = [
  {
    ...
    date: "2025-02-10",
    summary: "Our hospital has recently acquired a cutting-edge MRI machine, enhancing our diagnostic capabilities.",
    content:
  ...
  },
  {
    ...
    date: "2025-01-28",
    summary: "We're pleased to welcome Dr. Jane Smith, a renowned cardiologist, to our medical team.",
    content:
    ...
    <div className="space-y-8">
      {newsItems.map((item) => (
        <div key={item.id} className="bg-white p-6 rounded-lg shadow-md">
          ...
          <p className="text-gray-600 mb-4">{expandedItems.includes(item.id) ? item.content : item.summary}</p>
          <Button variant="outline" onClick={() => toggleItem(item.id)}>
